export default function Footer() {
  return (
    <div className="relative z-10 w-full min-h-[10dvh] flex flex-col text-amber-700 pt-3 bg-brand-grad-b">
      <div className="footer-container flex flex-1">
        <div className="address-container flex justify-start pl-3 sm:pl-5">
          <p className="text-sm">
            The krafted Cup <br />
            296 Talbot St N, <br />
            Essex, ON <br />
